...
const Modal: React.FC<TModalProps> = ({
  ...
  return (
    <div
      ...
      } w-full h-screen fixed top-0 left-0 z-[200000000] bg-gray-800/50 backdrop-blur-xs flex items-center justify-center font-Nunito transition-all duration-500`}
    >
      <div
        className={`${
